...
La preparación comienza automáticamente al abrir Ingress, pero no modifica los componentes activos. La sustitución conjunta de EBRO Auto y HABRO Companion solo se ejecuta tras una confirmación visible y queda restringida por código a `/homeassistant/custom_components`. Desde 0.1.28, esa confirmación inicia un recorrido reanudable que instala, reinicia exclusivamente Home Assistant Core, verifica el destino exacto y completa o restaura sin controles técnicos adicionales. Todavía no configura las cuentas ni crea entradas de integración.
